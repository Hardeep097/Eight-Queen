...
namespace Chess
{
    public class ChessBoard
    {
        ...
        //this method will check if queen is safer to place on chess 
        public bool IsSafe()
        {
            // no queen may be on same row 
            ...
            // no queen may be on the same diagonal
            for (int i = 1; i <= 8; i++)
            {
                for (int j = i + 1; j <= 8; j++)
                {
        ...
        //this method will  find one perfect solution for queen to place on chess board
        // recursion is used to find solution 
        ...
        //this method will  find multiple perfect solution for queen to place on chess board
        // recursion is used to find solution 
